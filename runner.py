...
from axl import axl_client
from csdm import csdm_client

log = logging.getLogger(__name__)

axl_client = axl_client(os.getenv( 'AXL_USERNAME'), os.getenv( 'AXL_PASSWORD'),os.getenv( 'CUCM_ADDRESS' ))
axl_client.create_session()

csdm_client = csdm_client(os.getenv('CSDM_ORGID'), os.getenv('CSDM_ACESSTKN'))
log.info(os.getenv('CSDM_ORGID'))
log.info(os.getenv('CSDM_ACESSTKN'))

'''
#TODO
read userid, devicemac from command prompt

'''
userid = 'adkothar'
devicemac = '78:BC:1A:3D:72:F4'
